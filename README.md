...
**kSocial** — это мой учебный проект социальной сети, построенная на современных веб-технологиях. Проект позволяет пользователям создавать профиль, добавлять друзей, публиковать посты, комментировать, лайкать, а также обмениваться сообщениями в реальном времени.
